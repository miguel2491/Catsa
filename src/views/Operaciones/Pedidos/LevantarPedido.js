...
import { GetClienteObraI,convertArrayOfObjectsToCSV} from '../../../Utilidades/Funciones';
import {
  CButton,
  CContainer,
  CRow,
...
const LevantarPedido = () => {    
    ...
    const btnBuscar = async() =>{
        ...
        try {
          // Llamada a la API
            const cotI = await GetClienteObraI(plantasSel,'V','C','0','0');
